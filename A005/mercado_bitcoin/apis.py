...
class DaySummaryApi(MercadoBitcoinApi):
    ...
    def get_endpoint(self, date: datetime.date) -> str:
...
class TradesApi(MercadoBitcoinApi):
    ...
    @staticmethod
    def get_unix_epoch(date: datetime.datetime) -> int:
        return int(date.timestamp())

    def get_endpoint(self, date_from: datetime.datetime = None, date_to: datetime.datetime = None) -> str:
